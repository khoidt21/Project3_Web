    ...
    <body>
        <section class="text-center animated fadeInDown">
            <div class="container text-center">
                ...
                <h3>Welcome to the Board, <%=u.getUsername()%></h3>
                ...
                <h3>Welcome back, <%=u.getUsername()%></h3>
                <p style="padding-bottom: 10px">Click button below to know more</p>
                ...
                <p><a class="btn btn-primary" style="width: 130px" href="./profile.jsp">Profile</a></p>
                <p><a class="btn btn-primary" style="width: 130px" href="./userCounter.jsp">User Counter</a></p>
            </div>
        </section>
